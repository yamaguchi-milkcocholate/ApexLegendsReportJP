export default {
    ...
    data: function() {
        return {
            ...
            hacker_message: "",
            cheating : [
                {key: "Advertising Cheat Tool", value: "チートの宣伝", text: "コメント欄やボイスチャットでのチートの宣伝。業者。"},
                {key: "Speed Hack", value: "加速チート", text: "移動速度をあげて行動できる"},
                {key: "Wall Hack", value: "ウォールハック", text: "壁が透けて見える"},
                {key: "Chams", value: "着色", text: "物体やプレイヤーに色が着いて見えやすくなる"},
                {key: "No Recoil", value: "無反動", text: "武器の反動がない"},
                {key: "Auto Aim", value: "オートエイム", text: "自動的にプレイヤーの頭部に照準が合う"},
                {key: "One Hit Kill", value: "ワンヒットキル", text: "一発の銃弾で敵を倒せる"},
                {key: "Macro", value: "マクロ", text: "異常な高速タップなど不可能な動作をワンクリックで行える"},
                {key: "Motion Cut", value: "モーションカット", text: "武器の持ち替えなどの動作をなくす"},
